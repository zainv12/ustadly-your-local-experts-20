...
export const professionals: Professional[] = [
  ...
  { id: "nadeem-ali", name: "Nadeem Ali", trade: "Electrician", category: "Electricians", rating: 4, photo: w3,
    ...
    languages: ["English", "Urdu"] },
  { id: "kamran-elec", name: "Kamran Aslam", trade: "Electrician", category: "Electricians", rating: 5, photo: w2,
    about: "Specialist in solar installations, inverters and UPS systems.",
    phone: "+92 XXX XXX XXXX", email: "kamran@email.com", location: "Faisalabad, Pakistan",
    education: "DAE Electrical", educationDetail: "Solar & renewable energy certified.",
    languages: ["English", "Urdu", "Punjabi"] },
  { id: "rashid-elec", name: "Rashid Mahmood", trade: "Electrician", category: "Electricians", rating: 4, photo: w1,
    about: "Industrial wiring, generator maintenance and motor rewinding expert.",
    phone: "+92 XXX XXX XXXX", email: "rashid@email.com", location: "Sialkot, Pakistan",
    education: "Diploma in Industrial Electrical", educationDetail: "12+ years on factory floors.",
    languages: ["Urdu", "Punjabi"] },
  { id: "junaid-elec", name: "Junaid Akram", trade: "Electrician", category: "Electricians", rating: 5, photo: w3,
    about: "Smart home automation, CCTV wiring and home theater electricals.",
    phone: "+92 XXX XXX XXXX", email: "junaid@email.com", location: "Karachi, Pakistan",
    education: "BSc Electrical Technology", educationDetail: "Certified low-voltage installer.",
    languages: ["English", "Urdu"] },
